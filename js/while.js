...
// let conesBeingBought;
// let conesSoldTest = (allCones < conesBeingBought)
// do {
//     conesBeingBought = Math.floor(Math.random() * 5) + 1;
//     console.log(conesBeingBought);
//     if (allCones > conesBeingBought) {
//         console.log(conesBeingBought + " cones sold...");
//         allCones = allCones - conesBeingBought;
//     } else {
//         console.log("Cannot sell you " + conesBeingBought + " cones I only have " + allCones + "...");
//     }
// } while (!conesSoldTest)
